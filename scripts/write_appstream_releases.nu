...
{tag: releases content: ($changelog | each {|e| {tag: release attributes: {version: $e.version date: $e.date } content: [(if $e.release_url != null {{tag: url attributes: {type: "details"} content: [$e.release_url] }} else {""}), {tag: description content: (html_to_xml_tree $e.description)}] } } | prepend {tag: '!' attributes: null content: " This file is autogenerated - do not edit. See scripts/write_appstream_releases.nu "} ) } | to xml --indent 2 --self-closed | save ./assets/link.ellis.jade.fendapp.releases.xml -f
